...
class CityCategoryTabsWidget extends StatefulWidget {
  final Function(int?) onCategorySelected;

  const CityCategoryTabsWidget({super.key, required this.onCategorySelected});

  @override
  State<CityCategoryTabsWidget> createState() => _CityCategoryTabsWidgetState();
}

class _CityCategoryTabsWidgetState extends State<CityCategoryTabsWidget> {
  int _isSelected = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CategoryBloc, CategoryState>(
      builder: (context, state) {
        ...
        if (state is LoadCategoriesError) return const SizedBox.shrink();
