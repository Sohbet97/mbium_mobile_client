        ...
        if (model.isVerified == true) ...[
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.bonusBannerTextGreen.withValues(alpha: 0.08),
              borderRadius: BorderRadius.circular(14),
              border: Border.all(color: AppColors.bonusBannerTextGreen.withValues(alpha: 0.3)),
            ),
            child: Row(
              children: [
                Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                    color: AppColors.bonusBannerTextGreen.withValues(alpha: 0.12),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(l10n.tassyklanan_dukan, style: textStyles.s13w600clBlack),
