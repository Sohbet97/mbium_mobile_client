...
import 'package:mbium_mobile_client/feature/shops/presentation/widget/shop_detail_info_widget.dart';
    ...
    return BlocListener<ProductBloc, ProductState>(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: ShopDetailInfoWidget(model: widget.model),
          ),
          const SliverToBoxAdapter(child: SizedBox(height: 8)),

          SliverToBoxAdapter(
            child: ShopDetailCategoriesWidget(model: widget.model),
          ),
          const SliverToBoxAdapter(child: SizedBox(height: 8)),
