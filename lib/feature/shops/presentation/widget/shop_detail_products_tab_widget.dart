...
class _ShopDetailProductsTabWidgetState
  ...
  Future<void> _openSortSheet() async {
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text('Tertiplemek', style: textStyles.s16w600clBlack),
              const SizedBox(height: 8),
              option('Iň arzan', 'price_asc', Icons.arrow_upward),
              option('Iň gymmat', 'price_desc', Icons.arrow_downward),
              option('Iň täze', 'newest', Icons.fiber_new_outlined),
              const SizedBox(height: 8),
            ],
          ),
        );
    ...
    if (result != _currentSort) {
      ...
      _dispatchFilter();
    } else if (result == null && _currentSort != null) {
    }
  }
