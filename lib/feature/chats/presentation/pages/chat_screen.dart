...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final shopName = widget.shop?.name ?? l10n.support;
    final logo = widget.shop?.logo;
    final logoUrl = logo != null && logo.isNotEmpty ? myMediaUrl + logo : null;
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              child: logoUrl == null
                  ? const Icon(Icons.store_outlined, color: AppColors.primaryGreen, size: 18)
                  : null,
            ),
